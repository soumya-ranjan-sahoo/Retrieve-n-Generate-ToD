...
def write_generation_preds(output_file, dialog_ids, responses, ground_truths, knowledge, tasks):
    new_labels = []
    # Update the dialogs with detection result
    for i, response in enumerate(responses):
        new_labels.append({"id": dialog_ids[i], "ground_truth": ground_truths[i], "response": response, 'knowledge': knowledge[i], 'task': tasks[i]})
